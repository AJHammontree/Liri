...
function fetchTwitter(){
    ...
    var params = {screen_name: 'AJHammontree'};
...
function fetchOMDB(movieName){
    ...
    var requestURL = "http://www.omdbapi.com/?t=" + movieName + "&y=&plot=short&apikey=trilogy";
    ...
    request(requestURL, function (error, response, body){
        ...
        appendFile("---------------------------------------------");
        appendFile("The movie's title is: " + JSON.parse(body).Title);
        appendFile("The movie's release year is: " + JSON.parse(body).Year);     
        appendFile("The movie's rating is: " + JSON.parse(body).imdbRating);
        appendFile("The movie's was produced in: " + JSON.parse(body).Country);
        appendFile("The movie's language is: " + JSON.parse(body).Language);
        appendFile("The movie's plot: " + JSON.parse(body).Plot);
        appendFile("The movie's actors: " + JSON.parse(body).Actors);
        appendFile("The movie's Rotten Tomatoes Rating: " + JSON.parse(body).Ratings[1].Value);                                            
    });
}
